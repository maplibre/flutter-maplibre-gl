...
class Convert {
  ...
  static CameraUpdate toCameraUpdate(Object o, MapLibreMap mapboxMap, float density) {
  ...
  static void interpretMapboxMapOptions(Object o, MapLibreMapOptionsSink sink, Context context) {
