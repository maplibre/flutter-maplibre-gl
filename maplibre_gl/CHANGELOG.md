...
**No breaking API changes for apps**: nothing stops compiling. Android apps need one small change and web apps one or two, below. The rest closes platform gaps in the public API and cuts start-up time and the cost of large data updates.\
