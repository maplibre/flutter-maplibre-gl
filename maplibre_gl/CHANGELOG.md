...
* **Android, iOS, Web**: `setLight()` sets the style's light source, which shades extruded geometries: `anchor`, `position`, `color` and `intensity`. Android and iOS take constant values, web also accepts expressions. See the [globe, terrain and sky guide](https://maplibre.org/flutter-maplibre-gl/advanced/globe-terrain-sky/) (#960).
