          ...
          : [
              ...
              ControlGroup(
                ...
                children: [
                  ...
                  ListTile(
                    title: Text(
                      'Halo Blur: ${_textHaloBlur.toStringAsFixed(1)}',
                    ),
                    subtitle: Slider(
                      value: _textHaloBlur,
                      min: 0.0,
              ...
              ControlGroup(
                ...
                children: [
                  ...
                  ListTile(
                    title: Text(
                      'Rotation: ${_textRotate.toStringAsFixed(0)}°',
                    ),
                    subtitle: Slider(
                      value: _textRotate,
                      min: 0.0,
              ...
              ControlGroup(
                ...
                children: [
                  ListTile(
                    title: Text(
                      'Offset X: ${_textOffsetX.toStringAsFixed(1)} em',
                    ),
                    subtitle: Slider(
                      value: _textOffsetX,
                      min: -2.0,
                  ...
                  ListTile(
                    title: Text(
                      'Offset Y: ${_textOffsetY.toStringAsFixed(1)} em',
                    ),
                    subtitle: Slider(
                      value: _textOffsetY,
                      min: -2.0,
