...
* **Example app**: the Hover Effect example, which demonstrates feature state, now runs on Android too, highlighting a state on tap since a touch screen has no mouse hover. On iOS it explains that feature state is not available there yet (#889).
